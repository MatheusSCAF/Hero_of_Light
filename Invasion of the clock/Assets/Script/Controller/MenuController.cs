...
{
    public Image logo;
    public Button BotaoJogar, BotaoOpcoes, BotaoSair, botaoCredito;
    [Space(20)]
    ...
    public string nomeCenaJogo = "CENA1", nomeCenaCredito;
    ...
    void Start()
    {
        ...
        botaoCredito.onClick.AddListener(() => Creditos());
    ...
    private void Opcoes(bool ativarOP)
    {
        ...
        logo.gameObject.SetActive(!ativarOP);
    ...
    {
        SceneManager.LoadScene(nomeCenaCredito);
    }
}